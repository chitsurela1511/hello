...
def getvals():
    ...
    print(f"namevalue.get(),phonevalue.get(),Gendervalue.get(),emergencyvalue.get(),paymentmode.get(),foodservicevalue.get())")
    

     
    with open("record.txt","w") as f1:
        f1.write(f"namevalue.get(),phonevalue.get(),Gendervalue.get(),emergencyvalue.get(),paymentmode.get(),foodservicevalue.get())")
